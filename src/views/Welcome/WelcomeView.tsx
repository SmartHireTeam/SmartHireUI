  ...
  return (
    <Container>
      ...
      <Row className="mt-5">
        <Col>
          <Card>
            <Card.Header>   <h2>Welcome to Resume Shortlisting Application</h2></Card.Header>
            <Card.Body>
      ...
      <Row className="mt-5">
        <Col>
          <Card>
            ...
            <Card.Body>
              <Card.Title>    <h3>Key Features</h3></Card.Title>
              <Card.Text>
                <ul>
      ...
      <Row className="mt-5">
        <Col>
          <Card>
            <Card.Header></Card.Header>
            <Card.Body>
              <Card.Title>     <h3>How It Works</h3></Card.Title>
              <Card.Text>
                <ul>
